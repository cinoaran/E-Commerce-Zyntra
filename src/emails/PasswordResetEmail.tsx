...
export const VerifyUserPassword = ({
  ...
  const previewText = `${appName} verify your password to access your account.`;
  return (
    <Html>
      <Head />
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-10 max-w-116 p-5">
            <Heading className="mx-0 my-7 text-center font-normal text-[24px] text-black">
              Verify your password on{" "}
            ...
            <Text className="text-[14px] text-black leading-6">
              ...
              , We provide you with a simple way to verify your password. Click
              the button below to get access to your account.
            </Text>
